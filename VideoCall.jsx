...
const VideoCall = () => {
  ...
  const getGridLayout = () => {
    const totalParticipants = peers.length + 1; // Including self
    
    if (isMobile) {
      if (isLandscape) {
        return totalParticipants <= 2 ? 'repeat(2, 1fr)' : 'repeat(3, 1fr)';
      } else {
        return totalParticipants === 1 ? '1fr' : 'repeat(2, 1fr)';
      }
    }
    ...
    <div style={{
      ...
      {multipleVoicesDetected && (
        <div style={{
          ...
          ...(isMobile && styles.mobileWarningBanner),
          top: isMobile ? (showControls ? '60px' : '10px') : '48px'
        }}>
      ...
      {multiSpeakerWarning && (
        <div style={{
          ...styles.warningBanner,
          ...(isMobile && styles.mobileWarningBanner),
          top: multipleVoicesDetected ? (isMobile ? '110px' : '98px') : (isMobile ? (showControls ? '60px' : '10px') : '0px'),
      ...
      {(!isMobile || showControls) && (
        <div style={{
          ...
          <div style={styles.roomInfo}>
            ...
            <div style={{
              ...styles.roomNumber,
              ...(isMobile && styles.mobileRoomNumber)
            }}>
              {roomNumber}
            </div>
            {userId && (
              <div style={{
                ...styles.userIdDisplay,
                ...(isMobile && styles.mobileUserIdDisplay)
              }}>
                ID: {userId.split('_')[2]}
              </div>
            )}
      ...
      {faceRecognitionEnabled && (!isMobile || showControls) && (
        <div style={{
          ...styles.faceRecognitionPanel,
          ...(isMobile && styles.mobileFaceRecognitionPanel)
        }}>
          <div style={styles.faceRecognitionHeader}>
            <span style={{
              ...styles.faceRecognitionTitle,
              ...(isMobile && styles.mobileFaceRecognitionTitle)
            }}>
              🔍 Face Recognition
            </span>
            <div style={{
      ...
      {faceAlerts.length > 0 && (
        <div style={{
          ...styles.faceAlertsContainer,
          ...(isMobile && styles.mobileFaceAlertsContainer)
        }}>
          {faceAlerts.map((alert) => (
            <div 
              ...
              style={{
                ...styles.faceAlert,
                ...(isMobile && styles.mobileFaceAlert),
      ...
      <div style={{
        ...styles.videoGrid,
        ...(isMobile && styles.mobileVideoGrid),
        gridTemplateColumns: getGridLayout(),
        paddingTop: (!isMobile || showControls) ? '16px' : '0px',
        paddingBottom: (!isMobile || showControls) ? '16px' : '80px'
      }}>
        {/* Local video */}
        <div style={{
          ...
          <div style={{
            ...styles.videoLabel,
            ...(isMobile && styles.mobileVideoLabel)
          }}>
      ...
      {(!isMobile || showControls) && (
        <div style={{
          ...styles.controlBar,
          ...(isMobile && styles.mobileControlBar)
        }}>
          <div style={{
            ...styles.controlGroup,
            ...(isMobile && styles.mobileControlGroup)
          }} onClick={toggleMic}>
            <button style={{
              ...styles.controlButton,
              ...(isMobile && styles.mobileControlButton),
          ...
          <div style={{
            ...
            {showEmojiPanel && (
              <div style={{
                ...styles.emojiPanel,
                ...(isMobile && styles.mobileEmojiPanel)
              }}>
                {REACTIONS.map((emoji) => (
                  <button
                    key={emoji}
                    ...
                    style={{
                      ...styles.emojiButton,
                      ...(isMobile && styles.mobileEmojiButton)
                    }}
                  >
                    {emoji}
                  </button>
          ...
          <div style={{
            ...
            <button style={{
              ...styles.leaveButton,
              ...(isMobile && styles.mobileLeaveButton)
            }}>
              📞
            </button>
            {!isMobile && (
      ...
      {showChat && (
        <div style={{
          ...styles.chatPanel,
          ...(isMobile && styles.mobileChatPanel)
        }}>
          <div style={{
            ...styles.chatHeader,
            ...(isMobile && styles.mobileChatHeader)
          }}>
            <h3 style={isMobile ? { fontSize: '16px' } : {}}>In-call messages</h3>
            <button 
              onClick={() => setShowChat(false)}
              style={{
                ...styles.chatCloseButton,
                ...(isMobile && styles.mobileChatCloseButton)
              }}
            >
              ✕
            </button>
          ...
          <div style={{
            ...styles.chatMessages,
            ...(isMobile && styles.mobileChatMessages)
          }}>
            {messages.length === 0 ? (
              <div style={{
                ...styles.emptyChatMessage,
                ...(isMobile && styles.mobileEmptyChatMessage)
              }}>
              ...
              messages.map((msg, idx) => (
                <div key={idx} style={{
                  ...styles.chatMessage,
                  ...(isMobile && styles.mobileChatMessage)
                }}>
          ...
          <div style={{
            ...
            ...(isMobile && styles.mobileChatInputContainer)
          }}>
            <input
              value={inputMsg}
            ...
            <button
              ...
              style={{
                ...
                ...(isMobile && styles.mobileChatSendButton),
